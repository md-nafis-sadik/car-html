...
@section('main')
    <header class="page-header">
        ...
        @component('components.header-content', ['name' => 'About Us'])
            @slot('caption')
        ...
        <div class="grid md:grid-cols-2 md:justify-between items-center gap-[50px] xl:gap-[100px]">
            <div class="order-2 sm:order-1">
                @include('components.section-summary', [
                    'header' => 'Catchy title here needed',
                    'caption' =>
    ...
    <section class="dark-container mt-11 !bg-[#2C2F36]">
        ...
        <div class="flex items-center gap-[9px] flex-col sm:flex-row justify-center" data-aos="fade-up">
            <a href="{{ route('hire.index') }}" class="w-full btn btn-primary sm:w-auto">
                Hire a Car
            </a>
            <a href="{{ route('book.index') }}" class="btn bg-white text-white bg-opacity-[0.11] w-full sm:w-auto">
                Book a service
            </a>
        </div>
    </section>
