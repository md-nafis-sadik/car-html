...
@section('title', 'Repair Centre')

@section('main')
    <header class="page-header">
        <img src="{{ asset('assets/images/default-header.png') }}" class="w-full h-full" alt="">

        @component('components.header-content', ['name' => 'Affordable Vehicle Repairs'])
            @slot('caption')
    ...
    <section class="dark-container mt-[76px]">
        ...
        <p class="max-w-[903px] text-white text-opacity-55 text-base sm:text-[23px] leading-7 font-medium text-center mx-auto mt-[30px] mb-[110px]"
            data-aos="fade-up">
            There is never a good time to need to bring your car in for repairs. In the best-case scenario, you may have
            noticed a minor issue slowly getting worse over time. In this instance, you will have taken your car to the
            garage to get it fixed before it becomes a major problem.
        </p>
            ...
            @component('components.section-summary')
                @slot('caption')
                    <span class="text-white">
                        But things do not always work out that simply. If you have suffered an accident, you may be facing some
                        serious damage that needs a lot of work. Or maybe something in your car will have broken without warning.
                    </span>
                @endslot
                @slot('textMedium')
                    <span class="text-white text-opacity-40">
                        Needing repair work for your car is a hugely stressful and difficult experience to go through, and at
                        Autofusion, we know that all you want is to get your car fixed up and back on the road as soon as possible.
                    </span>
                @endslot
            @endcomponent
    ...
    <section class="base-container">
        <div class="grid md:grid-cols-2 md:justify-between items-center gap-[50px]">
            ...
            <img src="{{ asset('assets/images/repair_5.png') }}" class="order-1 w-full h-auto sm:order-2 lg:-mt-32"
    ...
    <section class="base-container">
        <div class="grid md:grid-cols-2 md:justify-between items-center gap-[50px] xl:gap-[100px]">
            <img src="{{ asset('assets/images/repair_6.png') }}" class="w-full h-auto" alt="" data-aos="zoom-in">
