...
<section class="py-5">
    <div class="container-fluid px-3 px-lg-5">
        <div class="oy-banner bg-dark">
            ...
            <div class="p-md-5 rounded-6 oy-banner__home-hero" style="background-image: url('../assets/img/banners/gradient-banner-desktop-18.png');">
                <div class="row oy-banner__row g-4 g-xl-5 align-items-end justify-content-between">
                    <div class="col-lg-6 col-xl-6">
                        ...
                        <div class="space-y-3 d-md-none rounded-6 p-4 oy-banner__mobile" style="background-image: url('../assets/img/banners/gradient-banner-mobile-18.png');">
                            <p class="text-light text-opacity-50 text-b2-regular">Whether you're looking to turn heads with a supercar, arrive in style at a wedding, or travel comfortably for business, our diverse fleet and professional team ensure an exceptional experience from start to finish.</p>
                        </div>
                    </div>
                            ...
                            <form id="car_search_form" name="car_search_form" method="get" action="/hire/cars">
                                ...
                                <div class="card space-y-4 p-4 p-lg-5 rounded-5">
                                    ...
                                    <div class="e-control-group position-relative">
                                        ...
                                        <div id="location_dropdown" class="position-absolute w-100 bg-white border rounded shadow-lg d-none" style="z-index: 1050; max-height: 250px; overflow-y: auto; top: 100%; left: 0; margin-top: 4px;">
                                            <div class="p-2">
                                                <div class="location-option px-3 py-2 cursor-pointer rounded" data-value="" data-name="Any Location" style="cursor: pointer;">
                                                    Any Location
                                                </div>
                                                @foreach($locations as $location)
                                                    <div class="location-option px-3 py-2 cursor-pointer rounded" data-value="{{ $location->id }}" data-name="{{ $location->name }}" style="cursor: pointer;">
                                                        {{ $location->name }}
                                                    </div>
                                                @endforeach
                                            </div>
                                    ...
                                    <div class="e-select-group">
                                        ...
                                        <select name="pickup_time" id="pickup_time" class="form-select e-select rounded-3">
                                    ...
                                    <div class="e-select-group">
                                        ...
                                        <select name="type" id="type" class="form-select e-select rounded-3">
                                            <option value="">Vehicle Type</option>
                                            @foreach($carTypes as $type)
                                                <option value="{{ $type->slug }}" @if(request()->get('type') == $type->slug) selected @endif>{{ $type->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex h-100 flex-column justify-content-between gap-4">
                                ...
                                <img class="img-fluid rounded-4" src="../assets/img/banners/about-banner-2.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
