...
@section('head-info')
    ...
    <title>Select Tracker - {{ config('app.name') }}</title>
@endsection
...
@section('main')
    <div class="flex flex-col items-center justify-center mt-16 sm:mt-7">
        ...
        <section class="bg-white w-full lg:min-h-[calc(100vh-150px)] h-full mt-10">
            <form method="POST" action="{{ route('book.service.trackers.post', ['serviceType' => App\GarageReservation::getCurrentCart()->attributes['bookingType']]) }}" id="service-form">
                @csrf
                        ...
                        <div class="col-span-12 md:col-span-8">
                            <div class="pt-9 pb-[50px] px-4 md:px-11 bg-[#F3F4F6] sm:rounded-[14px]">
                                ...
                                <div class="flex flex-col gap-4">
                                    @foreach($trackerProducts as $opt)
...
{{--                                </p>--}}
                        ...
                        @include('book.partials.booking-summary-bar', [
                            'continueText' => 'Thanks, next we will ask you for tracker addons',
                            'continueURL' => '#',
