...
{{--    <link rel="stylesheet" href="{{ asset('css/templates/invoices/garage/style.css') }}">--}}
    <link rel="stylesheet" href="https://autofusioncars.co.uk/css/templates/invoices/garage/style.css">
            ...
            <div class="tm_invoice_in">
                ...
                <div class="tm_invoice_info tm_mb20">
                    ...
                    <div class="tm_invoice_info_list">
                        ...
                        <p class="tm_invoice_date tm_m0">Date: <b class="tm_primary_color">{{ $data['dateGenerated'] }}</b></p>
                    </div>
                </div>
...
{{--                                            <td class="tm_width_2">£{{ $product['pVAT'] }}</td>--}}
                                            ...
                                            @endif
{{--                                            <td class="tm_width_2">£{{ $product['pVAT'] }}</td>--}}
                                            <td class="tm_width_2 tm_text_right">£{{  number_format(str_replace(',', '', $product['pNetPrice']) * $product['pQty'], 2) }}</td>
                                        </tr>
                                    @endforeach
                                @endif
                                </tbody>
...
{{--                                @endif--}}
                ...
                <div class="tm_padd_15_20 tm_round_border">
                    ...
                    <p class="tm_m0">Pay to: Autofusion Motors<br>
