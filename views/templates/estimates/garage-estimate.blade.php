...
<body>
@php
    $estimate = \App\Estimate::whereReference($data['docNo'])->first();
@endphp
            ...
            <div class="tm_invoice_in">
                ...
                <div class="tm_invoice_info tm_mb20">
                    ...
                    <div class="tm_invoice_info_list">
                        <p class="tm_invoice_number tm_m0">Estimate Ref: <b class="tm_primary_color">{{ $data['docNo'] }}</b></p>
...
{{--                                            <td class="tm_width_2">£{{ $product['pVAT'] }}</td>--}}
                                            ...
                                            @endif
{{--                                            <td class="tm_width_2">£{{ $product['pVAT'] }}</td>--}}
                                            <td class="tm_width_2 tm_text_right">£{{  number_format($product['pNetPrice'] * $product['pQty'], 2) }}</td>
                                        </tr>
                                    @endforeach
                                @endif
                                </tbody>
