...
<body>
        ...
        <div class="oy-dashboard__content" style="background-image: url('{{ asset('/assets-v2/img/banners/dashboard-banner.jpg') }}');">
          ...
          <div class="card p-4 p-lg-5 rounded-5">
            ...
            <div class="form-group">
              <div class="file-upload-area" id="file-upload-area">
                <div class="file-upload-content">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="file-upload-icon">
                    <path d="M12 15V3M12 3L8 7M12 3L16 7" stroke="#CAD6EE" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M2 17L2.621 19.485C2.872 20.489 3.772 21.166 4.808 21.166H19.192C20.228 21.166 21.128 20.489 21.379 19.485L22 17" stroke="#CAD6EE" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                  </svg>
                  <p class="file-upload-text">Drop files here to upload</p>
                  <p class="file-upload-subtext">or <span class="file-upload-browse">browse</span></p>
                </div>
                <input type="file" class="form-control e-file-input" id="document-file" style="display: none;">
              </div>
            </div>
            ...
            <div class="d-md-none mt-5">
              <a href="#" class="btn w-100 btn--gradient-primary">
                <div class="btn__text">View All Bookings</div>
              </a>
            </div>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      const browseLink = document.querySelector('.file-upload-browse');
      ...
      fileUploadArea.addEventListener('drop', function(e) {
        ...
        if (files.length > 0) {
          ...
          // You can add code here to handle the uploaded files
