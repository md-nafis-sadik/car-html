          ...
          <div class="card p-4 p-lg-5 rounded-5">
            ...
            <div class="row g-4">
              ...
              <div class="col-sm-6 col-md-4 col-xl-3">
                <div class="card card__light p-4 rounded-4">
                  <div class="">
                    <div class="badge mb-3 bg-white rounded-pill text-bg-light py-2 text-b6-medium">Hire | Booked</div>
                    <h3 class="text-b5-medium mb-2 text-dark">AFH-2515440466</h3>
                    <div class="text-b5-semibold text-dark mb-2"><span class="text-secondary text-opacity-50">Pick Up:</span> 17 Dec 2025 (9 am)</div>
                    <div class="text-b5-semibold text-dark"><span class="text-secondary text-opacity-50">Car:</span> VW T-Roc R</div>

                    <div class="d-flex align-items-center justify-content-between mt-4">
                      <span class="text-b3-semibold text-dark">£1.00</span>
                      <a href="#" class="btn text-b6-medium py-2 px-4 btn--gradient-primary">Verify Licence</a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="d-block d-md-none mt-5">
              <a href="#" class="btn w-100 text-b5-medium py-3 btn--gradient-primary">
                <div class="btn__text">Bookings</div>
              </a>
            </div>
          </div>
