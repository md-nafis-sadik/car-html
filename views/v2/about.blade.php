...
<body>
  ...
  <section class="py-5">
    <div class="container-fluid px-3 px-lg-5">
      <div class="oy-banner bg-dark"
        style="background-image: url('{{ asset('/assets-v2/img/banners/gradient-banner-desktop-17.jpg') }}');">
          ...
          <div class="col-lg-6 col-xl-4">
            <div class="space-y-4 d-md-none">
              <img class="rounded-4 img-fluid w-100"
                src="{{ asset('/assets-v2/img/banners/gradient-banner-mobile-17.png') }}" />
  ...
  <!-- ==================== Section: Autofusion Process Highlights ==================== -->
      ...
      <div class="bg-dark rounded-6 section-padding-y overflow-hidden">
        <div class="container">
          <div class="row g-4 g-lg-5 justify-content-between">
            ...
            <div class="col-lg-6 col-xl-6">
              <img class="img-fluid w-100 rounded-4" src="{{ asset('/assets-v2/img/banners/about-banner-3.png') }}"
                alt="">
  ...
  <!-- ==================== Section: THE Process OF Choosing AN Autofusion ==================== -->
  <section class="section-padding-y">
    <div class="container">
      <div class="row g-4 g-lg-5">
        <div class="col-lg-6">
