        ...
        <div class="col-md-6 col-lg-4">
          <div class="card card--branch h-100">
            ...
            <div class="card--branch__content px-3 pt-4 pb-4 space-y-3 flex-fill d-flex flex-column align-items-start">
              <div class="mb-5">
                <h5 class="card--branch__title text-h5 fw-semibold mb-3">Edinburgh</h5>
                <p class="text-secondary text-b4-regular mb-0">Edinburgh Airport, Turnhouse Road, <br>Edinburgh, EH12 9DN</p>
              </div>
              ...
              <div class="card--branch__action d-flex justify-content-between align-items-center w-100 mt-auto">
                <div class="d-flex align-items-center gap-3">
                  ...
                  <div class="text-b3-semibold text-dark">+441312033817</div>
                </div>
                <div>
  ...
  <section class="">
    <div class="container-fluid px-3 px-lg-5">
      <div class="bg-dark rounded-6 section-padding-y overflow-hidden">
        <div class="container">
          <div class="row g-4 g-lg-5 mb-5 justify-content-between">
            <div class="col">
              <h3 class="text-h2 text-light">Why hire from us?</h3>
            </div>
            <div class="col-auto">
              <div class="d-none d-lg-block">
                <a class="btn btn--gradient-primary" href="#" style="--btn-before-size: 300px;">
          ...
          <div class="row g-4 g-lg-5 justify-content-between">
            <div class="col-lg-6 col-xl-6 order-lg-1">
              <img class="img-fluid w-100 rounded-4" src="{{ asset('/assets-v2/img/banners/hiring-banner.png') }}" alt="">
            </div>
            <div class="col-lg-6 col-xl-6 order-lg-0">
              <div class="row g-4 g-lg-5">
                <div class="col-sm-6">
