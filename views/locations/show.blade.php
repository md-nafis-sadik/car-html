            ...
            <div class="oy-banner bg-dark" style="background-image: url('{{ asset('assets-v2/img/banners/gradient-banner-desktop-2.png') }}');">
                <div class="row oy-banner__row g-4 g-xl-5 align-items-center justify-content-between">
                    <div class="col-lg-6 col-xl-6">
                        <div class="space-y-3">
                            <span class="badge rounded-pill text-bg-primary bg-opacity-10 text-primary text-b4-regular text-uppercase">{{ $location->name }}</span>
                            <h2 class="text-light text-h1 mb-5">{{ $location->name }}'s Leading Luxury Car Hire Service</h2>
                            <p class="text-light text-opacity-50 text-b2-regular">
                                @if($location->description)
                                    {{ $location->description }}
                                @else
                                    Premium car hire services at {{ $location->name }}
     ...
     <section class="section-padding-y overflow-hidden">
        <div class="container oy-section-title text-center">
            <div class="row g-4 justify-content-center">
                <div class="col-12 col-lg-12">
                    <h3 class="text-h2 mb-0">Choose From The World’s Most Iconic Luxury Cars at {{ $location->name }} </h3>
                    <div class="row justify-content-center">
                        <div class="col-lg-10">
                            <p class="text-b2-regular text-secondary">Discover a fleet curated for opulence right here in  {{ $location->name }}, featuring supercars, sports cars, and prestige luxury vehicles from the world’s finest marques.</p>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card card--product h-100">
                        <div class="card--product__thumb">
                            @if($car->main_image)
                            <img src="{{$car->main_image->getUrl('thumb')}}" alt="">
                            @else
                            <div class="w-100 bg-light d-flex align-items-center justify-content-center" style="height: 12rem;">
                                <svg class="text-secondary" width="48" height="48" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div class="card--product__content space-y-3 flex-fill d-flex flex-column align-items-start">
                            <span class="badge rounded-pill text-bg-primary bg-opacity-10 text-primary text-b5-regular text-uppercase">{{ $car->brand->name }}</span>
                            ...
                            <!-- Action -->
                             <div class="card--product__action d-flex justify-content-between align-items-end w-100 mt-auto">
                                <div>
                                    ...
                                    <div class="text-b1-semibold text-primary">£{{ number_format($car->pricing['daily'], 0) }}/day</div>
                                    @elseif($car->daily_rate)
                                    <div class="text-b1-semibold text-primary">£{{ number_format($car->daily_rate, 2) }}/day</div>
                                    @endif
                                </div>
                                <div>
                                    <a class="btn btn--outline-primary" href="{{ route('hire.cars.car', $car->slug) }}?location={{ $location->id }}">
        ...
        @if ($cars->hasPages())
            <div class="pagination-default mt-5 d-flex flex-wrap justify-content-center align-items-center gap-4">
                ...
                class="btn--circle outlined {{ $cars->onFirstPage() ? 'disabled' : '' }}"
                data-pulse-direction="right">
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M8.77344 5.43582L3.20927 11L8.77344 16.5642"
                            stroke="currentColor" stroke-width="2"
                            stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M18.791 11H3.36352"
                            stroke="currentColor" stroke-width="2"
                            stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </a>
                ...
                class="btn--circle text-b1-medium outlined {{ $cars->hasMorePages() ? '' : 'disabled' }}"
                data-pulse-direction="left">
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M13.2266 5.43582L18.7907 11L13.2266 16.5642"
                            stroke="currentColor" stroke-width="2"
                            stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M3.20898 11H18.6365"
                            stroke="currentColor" stroke-width="2"
                            stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </a>
                ...
                <div class="container">
                    <div class="row g-4 mb-5">
                        <div class="col-lg-12">
                            <div class="mb-5">
                                @if($location->address)
                                <iframe class="rounded-4" src="https://maps.google.com/maps?q={{ urlencode($location->address) }}&t=&z=15&ie=UTF8&iwloc=&output=embed" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                @elseif($location->lat && $location->lng)
                                <iframe class="rounded-4" src="https://maps.google.com/maps?q={{ $location->lat }},{{ $location->lng }}&t=&z=15&ie=UTF8&iwloc=&output=embed" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                @else
                                <div class="bg-light rounded-4 d-flex align-items-center justify-content-center" style="height: 16rem;" data-aos="fade-up">
                                    <p class="text-secondary mb-0">Map not available for this location</p>
                                </div>
                                @endif
                            </div>
                    ...
                    <div class="row g-4 g-lg-5 justify-content-between">
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    ...
                                    @if($location->phone)
                                    <a href="tel:{{ $location->phone }}" class="text-light text-b4-semibold">{{ $location->phone }}</a>
                                    @endif
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    ...
                                    @if($location->email)
                                    <a href="mailto:{{ $location->email }}" class="text-light text-b4-semibold">{{ $location->email }}</a>
                                    @endif
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                     @if($location->address)
                                    <div class="text-light text-b4-semibold">{{ $location->address }}</div>
                                    @endif
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div class="text-light text-b4-semibold"><span class="capitalize">{{ $day }}</span>
                                    <span>{{ $hours }}</span></div>
                                    @endforeach
                                    @endif
                                </div>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-6 order-lg-0">
                    <div class="space-y-3 ps-lg-5">
                        <h2 class="text-dark text-h3 mb-3">A Bespoke Luxury Car Hire Experience In {{ $location->name }} </h2>
                        ...
                        <p class="text-secondary text-opacity-50 text-b3-regular">Collect your luxury vehicle from Mayfair, arrange a delivery to Kensington, or return it at {{ $location->name }}. Everything is possible with our convenient pickup and drop-off across Central {{ $location->name }} to save you time and keep the driving experience first-class.</p>
                        
                        <div class="mt-5">
                            <a href="{{ route('hire.cars') }}?location={{ $location->id }}" class="btn btn--gradient-primary">
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-md-7 text-center">
                    <div class="text-center">
                        <h3 class="text-h3">Why Our Luxury Car Hire In {{ $location->name }} Is The One To Rely On</h3>
                        <p class="text-secondary text-b4-regular">Our luxury car hire service makes premium travel simple across Central {{ $location->name }}, Heathrow, Gatwick, Kensington, and Mayfair. We don’t outsource customer care or cut corners.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="bg-dark rounded-6 section-padding-y overflow-hidden">
                <div class="container">
                    <div class="row g-4 mb-5 justify-content-center">
                        <div class="col-lg-10">
                            <div class="mb-5">
                                <h3 class="text-h2 text-center text-light">Booking Your {{ $location->name }} Luxury Car Rental is Simple With Autofusion</h3>
                            </div>
                        </div>
                    </div>
                    <div class="row g-4 g-lg-5">
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="card p-4 p-lg-5 card__feature text-start h-100">
                                ...
                                <p class="text-b4-regular">Pick-up and drop-off across Central {{ $location->name }}, Heathrow, Gatwick, and surrounding areas. Your luxury car hire experience is tailored entirely to your day.</p>
                            </div>
                        </div>
                    </div>
                </div>
     ...
     <section class="section-padding-y">
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 order-lg-0">
                    <div class="space-y-3 ps-lg-5">
                        <h2 class="text-dark text-h2 mb-3">Covering Central {{ $location->name }} And Beyond</h2>
                        ...
                        <ul class="list-unstyled space-y-2">
                            ...
                            <li class="d-flex gap-3">
                                ...
                                <span>{{ $location->name }} Heathrow</span>
                            </li>
                            <li class="d-flex gap-3">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect width="20" height="20" rx="10" fill="#0072FF"/>
                        ...
                        <div class="mt-5">
                            <a href="{{ route('fleet') }}" class="btn btn--gradient-primary">
     ...
     <section class="oy-faq section-padding-y">
        <div class="container">
            <div class="oy-section-title text-center">
                <h3 class="text-h2">FAQs About Luxury Car Hire in {{ $location->name }}</h3>
            </div>
        </div>
        <div class="container">
            <div class="row justify-content-center">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="accordion-faq-2-heading--1" data-bs-parent="#accordion-faq--2">
                                <div class="accordion-body text-b2-regular text-secondary">
                                    To access our self-drive luxury car hire service, drivers need to be above the age of 25 and should have held their driving license for at least 2 years. Then you can pick up your supercar from Central {{ $location->name }}, Heathrow, or Gatwick.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
