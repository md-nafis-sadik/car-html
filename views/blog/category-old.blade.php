                    ...
                    <div class="ch-row">
                        <div class="sl:ch-col--8 sm:ch-col--6 md:ch-col--12">
                            <div class="md:ch-text--left xs:ch-text-center sl:ch-text--center">
                                <h1 class="ch-fs--7 md:ch-fs--8 sl:ch-text--center md:ch-text--left xs:ch-text--center">
                                    {{ $category->name }}</h1>
                                <p class="ch-fs--3 ch-mb--4 ch-measure ch-text--left">{{ $category->seo_description }}</p>
