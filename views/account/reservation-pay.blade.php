...
@section('head-info')
    <title>Complete Reservation - {{ config('app.name') }}</title>
    <meta name="description" content="Finalise your booking and checkout." />
    <link rel="canonical" href="{{ request()->url() }}" />
    <meta property="og:locale" content="en_GB" />
    <meta property="og:type" content="website" />
    <meta property="og:image" content="{{ asset('/images/homepage-header.jpeg') }}" />
    <meta property="og:title" content="Complete Reservation - {{ config('app.name') }}" />
    <meta property="og:description" content="Finalise your booking and checkout." />
